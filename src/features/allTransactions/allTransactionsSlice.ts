...
export const getAllTransactions: AsyncThunk<any, Transaction, AsyncThunkConfig> =
  createAsyncThunk('allTransactions/getTransactions', getAllTransactionsThunk);

export const showStats: AsyncThunk<any, Transaction, AsyncThunkConfig> = createAsyncThunk(
  'allTransactions/showStats',
  showStatsThunk
);
...
const transactionSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getAllTransactions.rejected, (state, { payload }: { payload: any }) => {
        state.isLoading = false;
        toast.error(payload);
      });
    builder
      ...
      .addCase(showStats.fulfilled, (state, { payload }: { payload: any }) => {
        state.isLoading = false;
        state.stats = payload.defaultStats;
      })
      .addCase(showStats.rejected, (state, { payload }: { payload: any }) => {
        state.isLoading = false;
        toast.error(payload);
      });
  }
